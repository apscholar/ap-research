---
title: "AP^&reg;^ Research Calendar (Mr. Li's Class)"
output: 
...
sch <- sch %>% 
  ...
  add_row(date = "2019-10-29", val = 2, item = "Practice Presentation Slides") %>%
  add_row(date = "2019-10-31", val = 2, item = "Practice Presentations") %>%
  add_row(date = "2019-11-01", val = 2, item = "Practice Presentations") %>%
