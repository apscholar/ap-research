...
sch <- tibble(date= as.Date(c("2019-08-15","2019-09-15", "2019-10-15")),
                  val = c(1, 1, 2),
              item = c("Inquiry Proposal Form", "Research Proposal", "Prelim. Presentation"))

sch <- sch %>% 
  add_row(date = "2019-11-01", val = 1, item = "Annotated Bibliography") %>%
  add_row(date = "2019-11-30", val = 3, item = "Submit final inquiry proposal form") %>%
  add_row(date = "2019-12-15", val = 2, item = "Presentation on lit. review") %>%
  add_row(date = "2020-01-10", val = 2, item = "Presentation on design/methods") %>%
  add_row(date = "2020-02-20", val = 1, item = "Paper draft 1") %>%
  add_row(date = "2020-03-15", val = 1, item = "Paper draft 2") %>%
  add_row(date = "2020-03-30", val = 1, item = "Final draft") %>%
